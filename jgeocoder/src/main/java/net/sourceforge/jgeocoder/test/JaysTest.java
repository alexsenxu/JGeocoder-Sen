...
//    for(int i =0; i<100; i++){
      ...
      //String fulladdress = "1 W Pratt St, Baltimore, Maryland 21201";
        String fulladdress = "3491946686 main street, seattle, wa 98004";
    //!!!!!!nullpointer bug !!!!!!!
      //String fulladdress = "PSC 10 BOX 1819, APO AE";
//geocoding test 0: fix misspelled city name:     ALBERTVILLO should be ALBERTVILLE
      //String fulladdress = "11645 57TH ST NE, ALBERTVILLO MN";
...
//geocoding test 4: APT number with letters     --this actually works
    //String fulladdress="22 LEHIGH ST APT 2A, HACKENSOCK NJ 07601";

//geocoding test 5: extremely messy/ambiguous address    
    //String fulladdress="V99 CALLE 5, 00727";
    
//geocoding test 6: separated PREDIR for street name: "E B HOLLOW RD" should be "EB HOLLOW RD" --not really
...
//geocoding test 8: ordinal number written in words --normalized/geocoded addresses already fixed that
...
//geocoding test 11: correct the city name, should be  "LYNN"   --normalized address and geocoded address already fixed that
    //String fulladdress="16 NELSON ST, EAST LYNN, MA 01905";

//geocoding test 12: addresses with POBox and APO addresses --problem is city: CHICAGO is recognized as street name, 
