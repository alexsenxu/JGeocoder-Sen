...
public class AddressParserTest
{
   ...
   public void testDesignatorConfusingCitiesParsing(){
     ...
     String addr2 = "320 Vairo Blvd, Apt C, State College, PA 16803";
     Map<AddressComponent, String> m2 = AddressStandardizer.normalizeParsedAddress(AddressParser.parseAddress(addr2));
     assertEquals("UNIVERSITY PARK", m2.get(AddressComponent.CITY));
     assertEquals("VAIRO", m2.get(AddressComponent.STREET));
